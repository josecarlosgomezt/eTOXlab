...
class imodel(model):
    def __init__ (self, vpath):
        ...
        self.quantitative = False           # True for quantitative dependent variables, False for qualitative
        ...
        ##
        ##########################################################################################################
        self.MD = 'adriana'                   # Program used to calculate the MD. Must be one of the following
        ...
        ##
        ##########################################################################################################
        self.model = 'RF'                  # Name of the modeling method used to build the model. Must be one of
	...
	self.RFclass_weight = "balanced"                                             # Acceptable values are 'sqrt', 'log2' and 'none'
